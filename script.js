...
const time_line = document.querySelector("headr .time_line");
...
function showQuestions(index) {
    ...
    + '<div class = "option"><span>' + questions[index].options[12] + '</span></div>'
    + '<div class = "option"><span>' + questions[index].options[13] + '</span></div>'
    + '<div class = "option"><span>' + questions[index].options[14] + '</span></div>';
